...
* `GraphDef`: This is C++ object generated by protobuf toolchain with a predefined structure in graph.proto. Plugin should maintain protobuf toolchain and the object itself, with a same proto file as defined in Tensorflow proper. Here lists all proto files needed in plugin:
